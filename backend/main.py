...
# Create Flask app - this is what Cloud Run expects
app = Flask(__name__)
...
def handle_generate_video(data, request):
    ...
    video_record = {
        ...
        'script': script,
        'video_url': video_url,
        'thumbnail': 'https://via.placeholder.com/320x180/1a1a2e/00d9a5?text=OMMAE+Video',
        'status': 'staged',
        'duration': '15s',
...
SCENE 1: [Nature footage] "At Mohawk Medibles, we honor traditional wellness..."

SCENE 2: [Product showcase] "{topic} - Premium indigenous cannabis"
